package com.bank.bian.corporaterelationship.model;
...
/**
 * The BIAN control record for this service domain: "Corporate Relationship Management Plan".
 *
 ...
 * to its asset type (Corporate Relationship). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Corporate Relationship Management Plan";
